...
- **(Bug Fix)** Amazon Q: Prevent IndexOutOfBoundsException by adding boundary checks for invalid range markers ([#5187](https://github.com/aws/amazon-q-jetbrains/issues/5187))
...
# _3.47_ (2025-01-09)
- **(Bug Fix)** Fix issue where users are unable to login to Amazon Q if they have previously authenticated ([#5214](https://github.com/aws/amazon-q-jetbrains/issues/5214))
...
- **(Bug Fix)** Fix chat not retaining history when interaction is through onboarding tab type ([#5189](https://github.com/aws/amazon-q-jetbrains/issues/5189))
...
- **(Bug Fix)** Chosing cancel on sign out confirmation now cancels the sign out and does not delete profiles from ~/.aws/config ([#5167](https://github.com/aws/amazon-q-jetbrains/issues/5167))
...
- **(Bug Fix)** Fix DynamoDB viewer throwing 'ActionGroup should be registered using <group> tag' on IDE start ([#5012](https://github.com/aws/amazon-q-jetbrains/issues/5012)) ([#5120](https://github.com/aws/amazon-q-jetbrains/issues/5120))
...
- **(Bug Fix)** Fix pointless busy loop in Amazon Q wasting CPU cycles ([#5000](https://github.com/aws/amazon-q-jetbrains/issues/5000))
...
- **(Bug Fix)** Fix an IDE deadlock that may occur while attempting to initialize Amazon Q UI elements ([#4966](https://github.com/aws/amazon-q-jetbrains/issues/4966))

# _3.32_ (2024-10-10)
- **(Feature)** Loosen inline completion support limitations for YAML/JSON
- **(Bug Fix)** Fix error occuring when Amazon Q attempts to show UI hints on manually triggerred inline suggestion ([#4929](https://github.com/aws/amazon-q-jetbrains/issues/4929))
- **(Bug Fix)** Amazon Q (/dev): provide error messaging when no code changes are required for the prompt
- **(Bug Fix)** Fix 'Slow operations are prohibited on EDT.' when Amazon Q is determining if a file supports inline suggestions ([#4823](https://github.com/aws/amazon-q-jetbrains/issues/4823))
...
- **(Bug Fix)** Fix UI slowdown when Amazon Q Inline Suggestions are enabled, but token cannot be refreshed ([#4868](https://github.com/aws/amazon-q-jetbrains/issues/4868))
- **(Bug Fix)** Fix "read access" error that may occur when Amazon Q Inline Suggestion is building context ([#4888](https://github.com/aws/amazon-q-jetbrains/issues/4888)) ([#4848](https://github.com/aws/amazon-q-jetbrains/issues/4848))
...
# _3.26_ (2024-08-30)
- **(Bug Fix)** Fix Runtime Exception when opening a tool window ([#4849](https://github.com/aws/amazon-q-jetbrains/issues/4849))
...
# _3.23_ (2024-08-15)
- **(Bug Fix)** Fix NPE in Rider AWS SAM project wizard ([#4768](https://github.com/aws/amazon-q-jetbrains/issues/4768))
...
- **(Bug Fix)** Don't allow Q/Core to be installed in the unsupported thin client context ([#4658](https://github.com/aws/amazon-q-jetbrains/issues/4658))
...
- **(Bug Fix)** Fix infinite restart loop on <=241 when an incompatible version of AWS Toolkit is installed alongside Amazon Q ([#4519](https://github.com/aws/amazon-q-jetbrains/issues/4519))
...
# _3.10_ (2024-06-07)
- **(Bug Fix)** Resolve a NullPointerException that could occur while handling editor creation event. ([#4554](https://github.com/aws/amazon-q-jetbrains/issues/4554))
...
- **(Bug Fix)** Fix AWS SSO connection when authenticating with RDS using an IAM Identity Center profile ([#4145](https://github.com/aws/amazon-q-jetbrains/issues/4145))
...
- **(Bug Fix)** Amazon Q: Fix an issue where /dev usage would cause the UI to freeze and take an unusually long time to complete. ([#4269](https://github.com/aws/amazon-q-jetbrains/issues/4269))
...
- **(Bug Fix)** Fix issue with competing SDK proxy configuration ([#4279](https://github.com/aws/amazon-q-jetbrains/issues/4279))
...
# _2.16_ (2024-03-29)
- **(Bug Fix)** Fix issue where Amazon Q Chat does not appear in IDEs other than IntelliJ IDEA ([#4218](https://github.com/aws/amazon-q-jetbrains/issues/4218))
...
- **(Bug Fix)** Fix scripts missing when connecting through JetBrains Gateway ([#4188](https://github.com/aws/amazon-q-jetbrains/issues/4188))
...
- **(Bug Fix)** Fix for AmazonQ on Linux input focus problem ([#4100](https://github.com/aws/amazon-q-jetbrains/issues/4100))
...
- **(Bug Fix)** Fix AWS Lambda configuration window resize ([#3657](https://github.com/aws/amazon-q-jetbrains/issues/3657))
...
- **(Bug Fix)** Always use AWS smile logo to reduce confusion if users are on the 'New UI' ([#3636](https://github.com/aws/amazon-q-jetbrains/issues/3636))
...
- **(Bug Fix)** Fix issue reconnecting to CodeWhisperer using an Identity Center directory outside of us-east-1 ([#3662](https://github.com/aws/amazon-q-jetbrains/issues/3662))
...
- **(Removal)** Remove support for Aurora MySQL v1 ([#3356](https://github.com/aws/amazon-q-jetbrains/issues/3356))
...
- **(Bug Fix)** Fix `java.lang.Throwable: Invalid html: tag <html> inserted automatically and shouldn't be used` ([#3608](https://github.com/aws/amazon-q-jetbrains/issues/3608))
...
- **(Feature)** Support for RDS MariaDB instances ([#3530](https://github.com/aws/amazon-q-jetbrains/issues/3530))
...
- **(Bug Fix)** Fix NPE that may occur when installing the toolkit for the first time ([#3433](https://github.com/aws/amazon-q-jetbrains/issues/3433))
- **(Bug Fix)** Fix network calls cant be made inside read/write action exception thrown from CodeWhisperer ([#3423](https://github.com/aws/amazon-q-jetbrains/issues/3423))
...
- **(Bug Fix)** Fix regression in requirements.txt detection ([#3041](https://github.com/aws/amazon-q-jetbrains/issues/3041))
- **(Bug Fix)** Fix `com.fasterxml.jackson.module.kotlin.MissingKotlinParameterException when choosing an input template in Lambda Run Configurations` ([#3359](https://github.com/aws/amazon-q-jetbrains/issues/3359))
- **(Bug Fix)** Fix Lambda Python console encoding issue ([#2802](https://github.com/aws/amazon-q-jetbrains/issues/2802))
...
- **(Bug Fix)** Fix `credential_process` retrieval when command contains quoted arguments on Windows ([#3322](https://github.com/aws/amazon-q-jetbrains/issues/3322))
- **(Deprecation)** An upcoming release will remove support for IDEs based on the 2021.3 platform
- **(Bug Fix)** Fix `java.lang.IllegalStateException: Region provider data is missing default data` ([#3264](https://github.com/aws/amazon-q-jetbrains/issues/3264))
...
- **(Bug Fix)** Fix hitting enter inside braces will produce an extra newline ([#3270](https://github.com/aws/amazon-q-jetbrains/issues/3270))
- **(Deprecation)** Remove support for deprecated Lambda runtime Python 3.6
- **(Removal)** Removed support for 2021.2.x IDEs

# _1.49_ (2022-08-11)
- **(Bug Fix)** Fix IllegalCallableAccessException thrown in several UI panels ([#3228](https://github.com/aws/amazon-q-jetbrains/issues/3228))
...
- **(Bug Fix)** Fix broken user UI due to 'Enter' handler override ([#3193](https://github.com/aws/amazon-q-jetbrains/issues/3193))
- **(Bug Fix)** Fix SSM plugin install on deb/rpm systems ([#3130](https://github.com/aws/amazon-q-jetbrains/issues/3130))
...
- **(Bug Fix)** Fixed issue with uncaught exception in resource cache ([#3098](https://github.com/aws/amazon-q-jetbrains/issues/3098))
- **(Bug Fix)** Don't attempt to setup run configurations for test code ([#3075](https://github.com/aws/amazon-q-jetbrains/issues/3075))
- **(Bug Fix)** Fix toolWindow not running in EDT
- **(Bug Fix)** Handle Lambda pending states while updating function ([#2984](https://github.com/aws/amazon-q-jetbrains/issues/2984))
- **(Bug Fix)** Fix modality issue when opening a CloudWatch log stream in editor ([#2991](https://github.com/aws/amazon-q-jetbrains/issues/2991))
...
# _1.43_ (2022-04-14)
- **(Bug Fix)** Fix regression in DataGrip 2022.1 caused by new APIs in the platform ([#3125](https://github.com/aws/amazon-q-jetbrains/issues/3125))
...
# _1.40_ (2022-03-07)
- **(Bug Fix)** Fix logged error due to ARN contributor taking too long ([#3085](https://github.com/aws/amazon-q-jetbrains/issues/3085))
...
# _1.38_ (2022-02-17)
- **(Bug Fix)** Fix StringIndexOutOfBoundsException ([#3025](https://github.com/aws/amazon-q-jetbrains/issues/3025))
...
- **(Bug Fix)** Fix plugin deprecation warning in DynamoDB viewer ([#2987](https://github.com/aws/amazon-q-jetbrains/issues/2987))
...
- **(Bug Fix)** Fix Python Lambda gutter icons not generating handler paths relative to the requirements.txt file ([#2853](https://github.com/aws/amazon-q-jetbrains/issues/2853))
- **(Bug Fix)** Fix file changes not being saved before running Local Lambda run configurations ([#2889](https://github.com/aws/amazon-q-jetbrains/issues/2889))
- **(Bug Fix)** Fix incorrect behavior with RDS Secrets Manager Auth when SSH tunneling is enabled ([#2781](https://github.com/aws/amazon-q-jetbrains/issues/2781))
- **(Bug Fix)** Fix copying out of the DynamoDB table viewer copying the in-memory representation instead of displayed value
- **(Bug Fix)** Fix error about write actions when opening files from the S3 browser ([#2913](https://github.com/aws/amazon-q-jetbrains/issues/2913))
- **(Bug Fix)** Fix NullPointerException on combobox browse components ([#2866](https://github.com/aws/amazon-q-jetbrains/issues/2866))
...
- **(Bug Fix)** Fix SSO login not being triggered when the auth code is invalid ([#2796](https://github.com/aws/amazon-q-jetbrains/issues/2796))
...
# _1.32_ (2021-09-07)
- **(Bug Fix)** Fix IDE error about context.module being null ([#2776](https://github.com/aws/amazon-q-jetbrains/issues/2776))
- **(Bug Fix)** Fix NullPointerException calling isInTestSourceContent ([#2752](https://github.com/aws/amazon-q-jetbrains/issues/2752))

# _1.31_ (2021-08-17)
- **(Feature)** Add support for Python 3.9 Lambdas
- **(Bug Fix)** Fix regression in SAM run configurations using file-based input ([#2762](https://github.com/aws/amazon-q-jetbrains/issues/2762))
- **(Bug Fix)** Fix CloudWatch sorting ([#2737](https://github.com/aws/amazon-q-jetbrains/issues/2737))

# _1.30_ (2021-08-05)
- **(Feature)** Add ability to view bucket by entering bucket name/URI
- **(Bug Fix)** Fix CWL last event sorting ([#2737](https://github.com/aws/amazon-q-jetbrains/issues/2737))
- **(Bug Fix)** Fix Go Lambda handler resolving into Go standard library ([#2730](https://github.com/aws/amazon-q-jetbrains/issues/2730))
- **(Bug Fix)** Fix `ActionPlaces.isPopupPlace` error after opening the AWS connection settings menu ([#2736](https://github.com/aws/amazon-q-jetbrains/issues/2736))
- **(Bug Fix)** Fix some warnings due to slow operations on EDT ([#2735](https://github.com/aws/amazon-q-jetbrains/issues/2735))
...
- **(Feature)** (Experimental) Adding ability to create a local terminal using the currently selected AWS connection (experiment ID `aws.feature.connectedLocalTerminal`, see [Enabling Experiments](https://github.com/aws/aws-toolkit-jetbrains/blob/master/README.md#experimental-features)) [#2151](https://github.com/aws/amazon-q-jetbrains/issues/2151)
...
- **(Bug Fix)** Fix using message bus after project has been closed (Fixes [#2615](https://github.com/aws/amazon-q-jetbrains/issues/2615))
...
- **(Bug Fix)** While debugging a Lambda function locally, make sure stopping the debugger will always stop the underlying SAM cli process ([#2564](https://github.com/aws/amazon-q-jetbrains/issues/2564))

# _1.26_ (2021-04-14)
- **(Feature)** Add support for creating/debugging Golang Lambdas ([#649](https://github.com/aws/amazon-q-jetbrains/issues/649))
- **(Bug Fix)** Fix breaking run configuration gutter icons when the IDE has no languages installed that support Lambda local runtime ([#2504](https://github.com/aws/amazon-q-jetbrains/issues/2504))
- **(Bug Fix)** Fix issue preventing deployment of CloudFormation templates with empty values ([#1498](https://github.com/aws/amazon-q-jetbrains/issues/1498))
- **(Bug Fix)** Fix cloudformation stack events failing to update after reaching a final state ([#2519](https://github.com/aws/amazon-q-jetbrains/issues/2519))
- **(Bug Fix)** Fix the Local Lambda run configuration always reseting the environemnt variables to defaults when using templates ([#2509](https://github.com/aws/amazon-q-jetbrains/issues/2509))
- **(Bug Fix)** Fix being able to interact with objects from deleted buckets ([#1601](https://github.com/aws/amazon-q-jetbrains/issues/1601))
...
- **(Feature)** Debugging Python based Lambdas locally now have the Python interactive console enabled (Fixes [#1165](https://github.com/aws/amazon-q-jetbrains/issues/1165))
- **(Feature)** Add a setting for how the AWS profiles notification is shown ([#2408](https://github.com/aws/amazon-q-jetbrains/issues/2408))
- **(Feature)** Deleting resources now requires typing "delete me" instead of the resource name
- **(Feature)** Add support for 2021.1
- **(Feature)** Allow deploying SAM templates from the CloudFormaton node ([#2166](https://github.com/aws/amazon-q-jetbrains/issues/2166))
- **(Bug Fix)** Improve error messages when properties are not found in templates ([#2449](https://github.com/aws/amazon-q-jetbrains/issues/2449))
- **(Bug Fix)** Fix resource selectors assuming every region has every service ([#2435](https://github.com/aws/amazon-q-jetbrains/issues/2435))
- **(Bug Fix)** Docker is now validated before building the Lambda when running and debugging locally (Fixes [#2418](https://github.com/aws/amazon-q-jetbrains/issues/2418))
- **(Bug Fix)** Fixed several UI inconsistencies in the S3 bucket viewer actions
- **(Bug Fix)** Fix showing stack status notification on opening existing CloudFormation stack ([#2157](https://github.com/aws/amazon-q-jetbrains/issues/2157))
- **(Bug Fix)** Processes using the Step system (e.g. SAM build) can now be stopped ([#2418](https://github.com/aws/amazon-q-jetbrains/issues/2418))
...
- **(Bug Fix)** Fix Secrets Manager-based databse auth throwing NullPointer when editing settings in 2020.3.2 (Fixes [#2403](https://github.com/aws/amazon-q-jetbrains/issues/2403))
- **(Bug Fix)** Fix making an un-needed service call on IDE startup ([#2426](https://github.com/aws/amazon-q-jetbrains/issues/2426))

# _1.23_ (2021-02-04)
- **(Feature)** Add "Copy S3 URI" to S3 objects ([#2208](https://github.com/aws/amazon-q-jetbrains/issues/2208))
...
- **(Bug Fix)** Re-add environment variable settings to SAM template based run configurations ([#2282](https://github.com/aws/amazon-q-jetbrains/issues/2282))
- **(Bug Fix)** Fix error thrown on profile refresh if removing a profile that uses source_profile ([#2309](https://github.com/aws/amazon-q-jetbrains/issues/2309))
...
- **(Bug Fix)** Fix cell based copying in CloudWatch Logs ([#2333](https://github.com/aws/amazon-q-jetbrains/issues/2333))
- **(Bug Fix)** Fix certain S3 buckets being unable to be shown in the explorer ([#2342](https://github.com/aws/amazon-q-jetbrains/issues/2342))
- **(Bug Fix)** Fix exception thrown in the new project wizard when run immediately after the toolkit is installed
- **(Bug Fix)** Fixing issue with SSO refresh locking UI thread ([#2224](https://github.com/aws/amazon-q-jetbrains/issues/2224))

# _1.22_ (2020-12-01)
- **(Feature)** Container Image Support in Lambda
- **(Bug Fix)** Fix update Lambda code for compiled languages ([#2231](https://github.com/aws/amazon-q-jetbrains/issues/2231))

# _1.21_ (2020-11-24)
- **(Breaking Change)** Remove support for 2019.3, 2020.1 is the new minimum version
- **(Feature)** Add copy Logical/Physical ID actions to Stack View [#2165](https://github.com/aws/amazon-q-jetbrains/issues/2165)
...
- **(Feature)** Add copy actions to CloudFormation outputs ([#2179](https://github.com/aws/amazon-q-jetbrains/issues/2179))
- **(Feature)** Support for the 2020.3 family of IDEs
- **(Feature)** Add an AWS Explorer ECR node
- **(Bug Fix)** Significantly speed up loading the list of S3 buckets ([#2174](https://github.com/aws/amazon-q-jetbrains/issues/2174))
...
- **(Bug Fix)** Fix several cases where features not supported by the host IDE are shown ([#1980](https://github.com/aws/amazon-q-jetbrains/issues/1980))
...
- **(Bug Fix)** Fix issue where templates > 51200 bytes would not deploy with "Deploy Serverless Application" ([#1973](https://github.com/aws/amazon-q-jetbrains/issues/1973))
- **(Bug Fix)** Fix the function selection panel not reloading when changing SAM templates ([#955](https://github.com/aws/amazon-q-jetbrains/issues/955))
...
- **(Bug Fix)** Fix the CloudWatch Logs table breaking when the service returns an exception during loading more entries ([#1951](https://github.com/aws/amazon-q-jetbrains/issues/1951))
- **(Bug Fix)** Improve watching of the AWS profile files to incorporate changes made to the files outisde of the IDE
- **(Bug Fix)** Fix SAM Gradle Hello World syncing twice ([#2003](https://github.com/aws/amazon-q-jetbrains/issues/2003))
- **(Bug Fix)** Quote template parameters when deploying a cloudformation template

# _1.17_ (2020-07-16)
- **(Feature)** Wrap logstream entries when they are selected ([#1863](https://github.com/aws/amazon-q-jetbrains/issues/1863))
...
- **(Feature)** Add word wrap to CloudFormation status reasons on selection ([#1858](https://github.com/aws/amazon-q-jetbrains/issues/1858))
...
# _1.15_ (2020-05-21)
- **(Feature)** Add the ability to build in container when updating function code ([#1740](https://github.com/aws/amazon-q-jetbrains/issues/1740))
...
- **(Feature)** Add capabilities check boxes to serverless deploy (issue [#1394](https://github.com/aws/amazon-q-jetbrains/issues/1394))
- **(Bug Fix)** Fix duplicate entries in SAM Init panel (issue [#1695](https://github.com/aws/amazon-q-jetbrains/issues/1695))
...
- **(Bug Fix)** Fix issue [#1011](https://github.com/aws/amazon-q-jetbrains/issues/1011), python test files will no longer be recognized as lambda handlers
...
- **(Bug Fix)** Upgraded AWS Java SDK to pull in latest model changes ([#1099](https://github.com/aws/amazon-q-jetbrains/issues/1099))
- **(Bug Fix)** Fix DynamoDB template for Python does not create correctly.
- **(Bug Fix)** Fix DaemonCodeAnalyzer restart not happening in a read action ([#1012](https://github.com/aws/amazon-q-jetbrains/issues/1012))
- **(Bug Fix)** Fix the bug when project is in different drive than the temp folder drive for Windows. [#950](https://github.com/aws/amazon-q-jetbrains/issues/950)
...
- **(Bug Fix)** Fix read/write action issues when invoking a Lambda using SAM ([#1081](https://github.com/aws/amazon-q-jetbrains/issues/1081))
- **(Bug Fix)** Make sure all STS assume role calls are not on the UI thread ([#1024](https://github.com/aws/amazon-q-jetbrains/issues/1024))

# _1.4_ (2019-06-10)
- **(Feature)** Usability enhancements to the CloudFormation UI
  - color coding status similar to the AWS Console
  - preventing multiple tabs opening for the same stack ([#798](https://github.com/aws/amazon-q-jetbrains/issues/798))
  - opening from AWS Explorer with right-click instead of double click ([#799](https://github.com/aws/amazon-q-jetbrains/issues/799))
...
- **(Bug Fix)** Make sure we commit all open documents if using a file-based event input ([#910](https://github.com/aws/amazon-q-jetbrains/issues/910))
- **(Bug Fix)** Fix being unable to open an empty credentials/config file for editing

# _1.3_ (2019-04-25)
- **(Feature)** Respect IDE HTTP proxy settings when making calls to AWS services. Fixes [#685](https://github.com/aws/amazon-q-jetbrains/issues/685).
...
- **(Bug Fix)** Fix being unable to add breakpoints to Python Lambdas on Windows, Fixes [#908](https://github.com/aws/amazon-q-jetbrains/issues/908)
- **(Bug Fix)** Fix gutter icon not shown in Project whoses runtime is not supported by Lambda but runtime group is supported
- **(Bug Fix)** Fix building of a Java Lambda handler failing due to unable to locate build.gradle/pom.xml Fixes [#868](https://github.com/aws/amazon-q-jetbrains/issues/868), [#857](https://github.com/aws/amazon-q-jetbrains/issues/857)
- **(Bug Fix)** Fix template not found after creating a project, fixes [#856](https://github.com/aws/amazon-q-jetbrains/issues/856)
...
- **(Bug Fix)** Unable to edit AWS credential file via pycharm ([#759](https://github.com/aws/amazon-q-jetbrains/issues/759))
- **(Bug Fix)** Fix issue where invalid AWS Credentials prevent plugin startup
- **(Bug Fix)** Require SAM run configurations to have an associated credential profile ([#526](https://github.com/aws/amazon-q-jetbrains/issues/526))

# _1.1_ (2019-01-08)
- **(Feature)** Additional information provided when AWS Explorer isn't able to load data - [#634](https://github.com/aws/amazon-q-jetbrains/issues/634) [#578](https://github.com/aws/amazon-q-jetbrains/issues/578)
...
- **(Bug Fix)** Fix case where packaging Java code was not releasing file locks [#694](https://github.com/aws/amazon-q-jetbrains/issues/694)
...
- **(Bug Fix)** Ignore .DS_Store files when building Lambda zip ([#725](https://github.com/aws/amazon-q-jetbrains/issues/725))
- **(Bug Fix)** Fix IllegalStateException: context.module must not be null ([#643](https://github.com/aws/amazon-q-jetbrains/issues/643))
- **(Bug Fix)** Fixed issue on OS X where the SAM CLI is unable to use an UTF-8 locale.
- **(Bug Fix)** Fix the status message for certain states during CloudFormation stack updates ([#702](https://github.com/aws/amazon-q-jetbrains/issues/702))
